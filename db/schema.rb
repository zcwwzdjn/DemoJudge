...
ActiveRecord::Schema.define(version: 20131108152559) do
  ...
  add_index "solutions", ["hacker_id"], name: "index_solutions_on_hacker_id"
  add_index "solutions", ["puzzle_id"], name: "index_solutions_on_puzzle_id"
